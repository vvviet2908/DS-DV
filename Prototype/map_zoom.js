...
var color = d3.scaleQuantize()
 ...
 var tooltip = d3.select("#map").append("path")
                 		 .attr("class", "tooltip")
			.style("opacity", 0)
    		.attr("class", "tooltip")
...
d3.csv("https://raw.githubusercontent.com/dangquanghung/covid/master/covid19_province.csv", function(data) {
...
d3.select(this).transition()
 ...
 tooltip.html("Province: " + d.properties.Ten + "<br>" + "Confirmed cases: " + d.properties.Confirm)
